...
namespace CollectionsAndIterationTest
{
    ...
    public class CollectionsExamplesTest
    {
        ...
        [Test]
        public void ShouldReturnTheSmallesttNumber()
        {
            List<int> numbers = new List<int> { 1, 2, 4, 3 };
        ...
        {
            List<int> numbers = new List<int> { 1, 2, 4, 3 };
            Assert.That(new CollectionsExamples().GetSecondLargest(numbers), Is.EqualTo(3));
            new CollectionsExamples().Doubled(numbers);
            //
