...
namespace CollectionsAndIterationTest
{
    ...
    public class CollectionsExamplesTest
    {
        ...
        public void ShouldReturnTheSecondLargestNumber()
        {
            ...
            Assert.That(_collectionsExamples.GetSecondLargest(numbers), Is.EqualTo(4));
        }
        ...
        public void ShouldReturnDoubledNumberInPlace()
        {
            ...
            List<int> doubledNumber = new List<int> { 8, 6, 4, 2, 10 };
            Assert.That(_collectionsExamples.DoubleInPlace(numbers), Is.EqualTo(doubledNumber));
        }
       ...
       [Test]
        ...
        {
            List<int> numbers = new List<int> { 4, 3, 2, 1, 5 };
            List<int> indexMultiplied = new List<int> { 0, 3, 4, 3, 20 };
            Assert.That(_collectionsExamples.MultipliedByIndex(numbers), Is.EqualTo(indexMultiplied));
        }
       ...
       public void ShouldReturnMultiplyByIndexInPlace()
       {
           List<int> numbers = new List<int> { 4, 3, 2, 1, 5 };
           List<int> indexMultiplied = new List<int> { 0, 3, 4, 3, 20 };
           Assert.That(_collectionsExamples.MultiplyByIndexInPlace(numbers), Is.EqualTo(indexMultiplied));
       }
       ...
       public void ShouldReturnContainsNumber()
       {
           const int N = 3;
           List<int> numbers = new List<int> { 4, 3, 2, 1, 5 };
           Assert.That(_collectionsExamples.ContainsNumber(numbers, N), Is.True);
