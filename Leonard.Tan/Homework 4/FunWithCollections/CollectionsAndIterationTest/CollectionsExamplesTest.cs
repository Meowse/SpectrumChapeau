...
namespace CollectionsAndIterationTest
{
    ...
    public class CollectionsExamplesTest
    {
       ...
       [Test]
        ...
        {
            List<int> numbers = new List<int> { 1, 2, 4, 3 };
            Assert.That(_collectionsExamples.GetSmallest(numbers), Is.EqualTo(1));
        }
       ...
       [Test]
       public void ShouldReturnTheMostExtreme()
       {
           List<int> numbers = new List<int> { -5, 2, 4, 3 };
           List<int> expectedResults = new List<int> {-5};
           List<int> results = new List<int>(_collectionsExamples.GetMostExtreme(numbers));
       ...
       {
           List<int> numbers = new List<int> { 1, 2, 4, 3 };
           Assert.That(_collectionsExamples.GetSecondLargest(numbers), Is.EqualTo(3));
       }
        ...
        [Test]
       public void ShouldReturnTheNthLargestNumber()
       {
           List<int> numbers = new List<int> { 11, 12, 13, 13, 14, 15 };
           Assert.That(_collectionsExamples.GetNthLargest(numbers, 3), Is.EqualTo(13));
       }
        ...
        public void ShouldReturnDoubled()
        {
            ...
            List<int> expectedResults = new List<int> { 2, 4, 6, 8 };
            List<int> results = new List<int>(_collectionsExamples.Doubled(numbers));
            CollectionAssert.AreEqual(expectedResults, results);
        }
        ...
        //
        [Test]
        public void ShouldReturnDoubledInPlace()
        {
            List<int> numbers = new List<int> { 1, 2, 3, 4 };
            List<int> expectedResults = new List<int> { 2, 4, 6, 8 };
            List<int> results = new List<int>(_collectionsExamples.DoubleInPlace(numbers));
            CollectionAssert.AreEqual(expectedResults, results);
        }
        ...
        {
            List<int> numbers = new List<int> { 1, 2, 3, 4 };
            List<int> expectedResults = new List<int> { 0, 2, 6, 12 };
            List<int> results = new List<int>(_collectionsExamples.MultipliedByIndex(numbers));
            CollectionAssert.AreEqual(expectedResults, results);
        }
        ...
        //
        [Test]
        public void ShouldReturnMultiplyByIndexInPlace()
        {
            List<int> numbers = new List<int> { 1, 2, 3, 4 };
            List<int> expectedResults = new List<int> { 0, 2, 6, 12 };
            List<int> results = new List<int>(_collectionsExamples.MultiplyByIndexInPlace(numbers));
            CollectionAssert.AreEqual(expectedResults, results);
        }
        ...
        {
            List<int> numbers = new List<int> { 1, 2, 3, 5, 6, 7, 8, 9, 10 };
            List<int> expectedResults = new List<int> { 1, 1, 3, 5, 3, 7, 1, 9, 5 };
            List<int> results = new List<int>(_collectionsExamples.OddBits(numbers));
            CollectionAssert.AreEqual(expectedResults, results);
        }
        ...
        // 
        [Test]
        public void ShouldReturnContainsNumber()
        {
            List<int> numbers = new List<int> { 11, 12, 13, 13, 14, 15 };
            Assert.That(_collectionsExamples.ContainsNumber(numbers, 3), Is.EqualTo(false));
        }
        ...
        //
        [Test]
        public void ShouldReturnHasNoDuplicates()
        {
            List<int> numbers = new List<int> { 11, 10, 14, 15 };
            Assert.That(_collectionsExamples.HasNoDuplicates(numbers), Is.EqualTo(true));
        }
        ...
        //
        [Test]
        public void ShouldReturnIsProperSubset()
        {
            List<int> subsetA = new List<int> { 11, 10, 14, 15 };
            List<int> subsetB = new List<int> { 11, 10, 14, 11 };
            Assert.That(_collectionsExamples.IsProperSubset(subsetA, subsetB), Is.EqualTo(false));
        }
        ...
        {
            List<int> numbers = new List<int> { 14, 11, 13, 12, 10, 15 };
            List<int> expectedResults = new List<int> { 10, 11, 12, 13, 14, 15 };
            List<int> results = new List<int>(_collectionsExamples.Sort(numbers));
            CollectionAssert.AreEqual(expectedResults, results);
        }
    }
}
